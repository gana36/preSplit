...
export const SettlementPhase: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-full relative">
            ...
            <div className="bg-white px-6 py-5 border-b border-gray-100">
                <div className="relative text-center mb-4">
                    <button
                        ...
                        className="absolute left-0 top-0 p-2 -ml-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-full transition-all"
                    >
                        <ArrowLeft className="w-5 h-5" />
                    </button>
                    <div className="text-xs text-gray-400 font-medium mb-1.5">Total Bill</div>
                ...
                <div className="flex justify-center">
                    <button
                        ...
                        className="flex items-center gap-3 px-4 py-2.5 rounded-full text-xs font-medium transition-all bg-gray-50 hover:bg-gray-100"
                    >
                        <div className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 ${roundToDollar ? 'bg-blue-500' : 'bg-gray-300'}`}>
                            <span className={`inline-block h-5 w-5 transform rounded-full bg-white shadow-md transition-transform duration-200 ${roundToDollar ? 'translate-x-5' : 'translate-x-0.5'}`} />
                        </div>
            ...
            {/* List */}
            <div className="flex-1 overflow-y-auto p-4 space-y-3 min-h-0 pb-4">
            ...
            {/* Footer Actions */}
            <div className="p-4 sm:p-5 bg-white border-t border-gray-100 pb-[max(16px,env(safe-area-inset-bottom))] shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
                <div className="grid grid-cols-2 gap-3">
                    <button
                        onClick={handleShare}
                        className="bg-gradient-to-br from-gray-800 to-gray-900 text-white py-4 rounded-xl font-semibold shadow-lg shadow-gray-900/20 hover:shadow-gray-900/30 active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-2"
                    >
                    ...
                    <button
                        ...
                        className="bg-[#25D366] text-white py-4 rounded-xl font-semibold shadow-lg shadow-green-200 active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-2"
                    >
